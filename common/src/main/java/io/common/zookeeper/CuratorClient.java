...
public class CuratorClient {
    ...
    public CuratorClient(String connectString, int timeout) {
        this(connectString, CommonOptions.ZK_NAMESPACE, timeout, timeout);
    }

    public CuratorClient(String connectString) {
        this(connectString, CommonOptions.ZK_NAMESPACE, CommonOptions.ZK_SESSION_TIMEOUT, CommonOptions.ZK_CONNECTION_TIMEOUT);
    }
